<template>
  <q-page class="flex flex-center">
    <div class="movies-list">
      <div class="text-white text-uppercase text-h2 q-pa-md">Top Rated</div>
      <q-space />
...
export default defineComponent({
  ...
  created() {
    ...
    fetch(
      "https://api.themoviedb.org/3/discover/movie?sort_by=vote_count.desc&api_key=0d2b4096e6984acc803ea54a5acb0d4e&page=1"
    )
  ...
  methods: {
    sortMovies(movies, i) {
      //reorder elements in array using vote_count
      movies[i].vote_count.sort(function (a, b) {
        return b - a;
      });
    },
